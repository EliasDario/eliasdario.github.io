...
request2.open('GET', 'https://api.wunderground.com/api/aeaf0d58b1a73e39/forecast/q/MN/Franklin.json', true);
request2.send();
...
weatherObj.open('GET', 'https://api.wunderground.com/api/aeaf0d58b1a73e39/conditions/q/MN/Franklin.json', true);
...
requestG.open('GET', 'https://api.wunderground.com/api/aeaf0d58b1a73e39/forecast/q/SC/Greenville.json', true);
requestG.send();
...
weatherObjG.open('GET', 'https://api.wunderground.com/api/aeaf0d58b1a73e39/conditions/q/SC/Greenville.json', true);
...
requestS.open('GET', 'https://api.wunderground.com/api/aeaf0d58b1a73e39/forecast/q/IL/Springfield.json', true);
requestS.send();
...
weatherObjS.open('GET', 'https://api.wunderground.com/api/aeaf0d58b1a73e39/conditions/q/IL/Springfield.json', true);
