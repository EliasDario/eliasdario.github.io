...
requestG.open('GET', '://api.wunderground.com/api/aeaf0d58b1a73e39/forecast/q/SC/Greenville.json', true);
requestG.send();
...
weatherObjG.open('GET', '://api.wunderground.com/api/aeaf0d58b1a73e39/conditions/q/SC/Greenville.json', true);
...
requestS.open('GET', '://api.wunderground.com/api/aeaf0d58b1a73e39/forecast/q/IL/Springfield.json', true);
requestS.send();
...
weatherObjS.open('GET', '://api.wunderground.com/api/aeaf0d58b1a73e39/conditions/q/IL/Springfield.json', true);
